...
def resultats_comparaison(fichier,fichier_test,*autres_fichiers):
 '''
 ...
 d["pourcentage de similarité des tests avec les fichiers"]=comparaison_test(fichier_test,*autres_fichiers)[0]
